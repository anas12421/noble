                            ...
                            <div class="wpo-accountForm form-style">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-md-12 col-12">
                                        ...
                                        <input type="text" id="name" name="fname" placeholder="Your name here.." value="{{old('fname')}}">
                                        @error('fname')
                                    ...
                                    <div class="col-lg-6 col-md-12 col-12">
                                        ...
                                        <input type="text" id="name" name="lname" placeholder="Your name here.." value="{{old('lname')}}">
                                    </div>
                                    <div class="col-lg-12 col-md-12 col-12">
                                        <label>Email</label>
                                        <input type="text" id="email" value="{{old('email')}}" name="email" placeholder="Your email here..">
                                        @error('email')
                                    ...
                                    <div class="col-lg-12 col-md-12 col-12">
                                        <div class="form-group">
                                            ...
                                            <input class="pwd2" type="password" placeholder="Your password here.." value="{{old('password')}}" name="password">
                                    ...
                                    <div class="col-lg-12 col-md-12 col-12">
                                        <div class="form-group">
                                            ...
                                            <input class="pwd3" type="password" placeholder="Your password here.." value="" name="password_confrimation">
                                            <span class="input-group-btn">
