...
footer {
  ...
  <body>
    <header class="clearfix">
      <div id="logo">
        <img src="https://i.postimg.cc/fyYZ7Wh3/preloader.png">
      </div>
      <div id="company">
        <h2 class="name">The Mart Limited</h2>
        <div>Begomabad, Kalatiya, Keranigonj, Dhaka-1313</div>
        <div>+880 1867 830522</div>
      ...
      <div id="details" class="clearfix">
        <div id="client">
          <div>
            ...
            <div class="email"><a href="{{$bill->email}}">{{$bill->email}}</a></div>
          </div>

          <div>
            <div class="to" style="margin-top: 10px">Shipped TO:</div>
            ...
            <div class="email"><a href="{{$ship->ship_email}}">{{$ship->ship_email}}</a></div>
          </div>
        </div>
        <div id="invoice">
      ...
      <table border="0" cellspacing="0" cellpadding="0">
        ...
        <tbody>
          ...
          @endphp
            ...
            <tr>
              <td class="no">{{$sl+1}}</td>
              <td class="desc"><h3>{{$orderproduct->rel_to_product->product_name}}</h3></td>
        ...
        <tfoot>
          ...
          <tr>
            ...
            <td>&#2547; {{$orders->total+$orders->charge+$vat}}</td>
          </tr>
        </tfoot>
      </table>
