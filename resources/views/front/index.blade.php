            ...
            <div class="hero-slider">
                @foreach ($banners as $banner)
                    <div class="hero-slider-item">
                        <div class="slider-bg">
                            <img src="{{ asset('uploads/banner') }}/{{ $banner->photo }}" alt="">
                        </div>
        ...
        <div class="container">
            ...
            <div class="featured-categorie-slider owl-carousel">
                ...
                @foreach ($categories as $category)
                    <div class="featured-item" title="{{ $category->category_name }}">
                        <div class="images d-flex align-items-center justify-content-center">
                            <img src="{{ asset('uploads/category') }}/{{ $category->icon }}" style="width: 80px"
                                alt="">
                        </div>
                        <div class="text">
                            <h2><a href="product.html">{{ substr($category->category_name, 0, 10) }}</a></h2>
                        </div>
                    </div>
                @endforeach
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-6 col-md-12">
                    <div class="offer-wrap" style="background: url({{ asset('uploads/offer') }}/{{ $offer1->photo }});">
                        <div class="content">
                            <h2>{{ $offer1->title }}</h2>
                            <span class="offer-price">&#2547;{{ $offer1->dis }}</span>
                            @if ($offer1->price)
                                <del>&#2547;{{ $offer1->price }}</del>
                            @endif
                ...
                <div class="col-lg-6 col-md-12">
                    <div class="banner-two-wrap"
                        style="background: url({{ asset('uploads/offer') }}/{{ $offer2->photo }});">
                        <div class="text">
                            <h2>{{ $offer2->title }}</h2>
                            <h4>{{ $offer2->sub_title }}</h4>
                            <a class="theme-btn-s2" href="product.html">Shop Now</a>
                        </div>
                    </div>
                </div>
            ...
            <div class="product-wrap">
                <div class="row">
                    ...
                    @foreach ($products as $product)
                        <div class="col-lg-3 col-md-4 col-sm-6 col-12" title="{{ $product->product_name }}">
                            <div class="product-item">
                                ...
                                <div class="text">
                                    ...
                                    @endphp
                                    <h2><a
                                            href="{{ route('check', $product->slug) }}">{{ substr($product->product_name, 0, 15) }}</a>
                                    </h2>
        ...
        <div class="container">
            <div class="upcoming-offer">
                ...
                <div class="left-image">
                    <img src="{{ 'frontend_assets' }}/images/upcomming-left.png" alt="">
                </div>
                ...
                <div class="right-image">
                    <img src="{{ 'frontend_assets' }}/images/upcomming-right.png" alt="">
                </div>
            ...
            <div class="trendin-slider owl-carousel">
                @foreach ($products as $product)
                    ...
                    <div class="product-item" title="{{ $product->product_name }}">
                        <div class="image">
                            <img height="200" src="{{ asset('uploads/product/preview') }}/{{ $product->preview }}"
                                alt="">
                            @if ($product->discount)
                                <div class="tag sale">-{{ $product->discount }}%</div>
                            @else
                    ...
                    <div class="highlight-wrap">
                        ...
                        <div class="product-card">
                            <div class="card-image">
                                <div class="image">
                                    <img src="{{ 'frontend_assets' }}/images/top-selling/1.png" alt="">
                                </div>
                            </div>
                            <div class="content">
                        ...
                        <div class="product-card">
                            <div class="card-image">
                                <div class="image">
                                    <img src="{{ 'frontend_assets' }}/images/top-selling/2.png" alt="">
                                </div>
                            </div>
                            <div class="content">
                        ...
                        <div class="product-card">
                            <div class="card-image">
                                <div class="image">
                                    <img src="{{ 'frontend_assets' }}/images/top-selling/3.png" alt="">
                                </div>
                            </div>
                            <div class="content">
                ...
                <div class="col-lg-4 col-md-6 col-12">
                    <div class="highlight-wrap">
                        ...
                        <div class="product-card">
                            <div class="card-image">
                                <div class="image">
                                    <img src="{{ 'frontend_assets' }}/images/top-rated/1.png" alt="">
                                </div>
                            </div>
                            <div class="content">
                        ...
                        <div class="product-card">
                            <div class="card-image">
                                <div class="image">
                                    <img src="{{ 'frontend_assets' }}/images/top-rated/2.png" alt="">
                                </div>
                            </div>
                            <div class="content">
                        ...
                        <div class="product-card">
                            <div class="card-image">
                                <div class="image">
                                    <img src="{{ 'frontend_assets' }}/images/top-rated/3.png" alt="">
                                </div>
                            </div>
                            <div class="content">
...
@section('footer_script')
    <script>
        if ($("#clock").length) {
            $('#clock').countdown('{{ $offer1->date }}', function(event) {
