                ...
                <div class="featured-categorie-slider owl-carousel">
                    ...
                    <div class="featured-item" title="{{$category->category_name}}">
                        <div class="images d-flex align-items-center justify-content-center">
                            <img src="{{asset('uploads/category')}}/{{$category->icon}}" style="width: 80px" alt="">
                        </div>
                        <div class="text">
        ...
        <section class="themart-offer-section section-padding">
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 col-md-12">
                        <div class="banner-two-wrap" style="background: url({{asset('uploads/offer')}}/{{$offer2->photo}});">
                            <div class="text">
                                <h2>{{$offer2->title}}</h2>
                    ...
                    <div class="col-lg-4 col-md-6 col-12">
                        <div class="highlight-wrap">
                            ...
                            <div class="product-card" title="{{$product->product_name}}">
                                <div class="card-image">
                                    <div class="image">
                                        <img width="170" height="130" src="{{asset('uploads/product/preview')}}/{{$product->preview}}" alt="">
                                    </div>
                                </div>
                                <div class="content">
