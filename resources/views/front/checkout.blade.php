                                ...
                                <div class="row">
                                    <div class="col-lg-6 col-md-12 col-12">
                                        <input type="text" placeholder="First Name*" id="fname1"
                                            name="fname" value="{{Auth::guard('customer')->user()->fname}}" {{old('fname')}}>
                                    ...
                                    <div class="col-lg-6 col-md-12 col-12">
                                        <input type="text" placeholder="Last Name*" id="fname2"
                                            name="lname"value="{{Auth::guard('customer')->user()->lname}}"  {{old('lname')}}>
                                    </div>
                                    <div class="col-lg-6 col-md-12 col-12">
                                        <select name="country_id" class="country" id="Country" class="form-control"  {{old('country')}}>
                                    ...
                                    <div class="col-lg-6 col-md-12 col-12">
                                        <select name="city_id" class="city" id="City" class="form-control">  {{old('city')}}
                                    ...
                                    <div class="col-lg-6 col-md-12 col-12 mt-2">
                                        <input type="number" placeholder="Postcode / ZIP*" id="Post2"
                                            name="zip" value="{{Auth::guard('customer')->user()->zip}}"  {{old('zip')}}>
                                    ...
                                    <div class="col-lg-6 col-md-12 col-12">
                                        <input type="text" placeholder="Email Address*" id="email4"
                                            name="email" value="{{Auth::guard('customer')->user()->email}}"  {{old('email')}}>
                                            @error('email')
                                    ...
                                    <div class="col-lg-6 col-md-12 col-12">
                                        <input type="text" placeholder="Phone*" id="number"
                                            name="phone" value="{{Auth::guard('customer')->user()->phone}}"  {{old('phone')}}>
                                            @error('phone')
                                    ...
                                    <div class="col-lg-12 col-md-12 col-12">
                                        <input type="text" placeholder="Address*" id="Adress"
                                            name="address" class="text-capitalize" value="{{Auth::guard('customer')->user()->address}}"  {{old('address')}}>
                                            @error('address')
                                    ...
                                    <div class="col-lg-12 col-md-12 col-12">
                                        <div class="note-area">
                                            <textarea name="note"
                                                placeholder="Additional Information"> {{old('note')}}</textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="billing-adress" id="open4">
                                <div class="contact-form form-style">
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6 col-md-12 col-12">
                                            <select style="width: 100% !important" name="ship_country_id" class="country2"  id="Country2" class="form-control w-100">
                                                <option value="" >Select Country</option>
                                        ...
                                        <div class="col-lg-6 col-md-12 col-12">
                                            <select style="width: 100% !important" name="ship_city_id" class="city2"  id="City2" class="form-control w-100">
                                                <option value="" >Select Country</option>
                                            </select>
                                        ...
                                        <div class="col-lg-12 col-md-12 col-12">
                                            <input type="text" class="text-capitalize" placeholder="Address*" id="Adress1"
                                                name="ship_address">
                                                @error('ship_zip')
            ...
            <div class="col-lg-4 col-12">
                <div class="cout-order-area">
                    ...
                    <div class="oreder-item">
                        ...
                        <div class="oreder-product mt-2" title="{{$cart->rel_to_product->product_name}}">
                            <div class="images text-center">
                                <span>
                                    <img style="width: 70%" src="{{asset('uploads/product/preview')}}/{{$cart->rel_to_product->preview}}" alt="">
                                </span>
                            </div>
                            <div class="product">
                                <ul>
                                    <li class="first-cart">{{substr($cart->rel_to_product->product_name,0,15)}}({{$cart->rel_to_product->after_discount}}x{{$cart->quantity}})</li>
                                    <li>
