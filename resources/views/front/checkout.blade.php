                            ...
                            <div class="billing-adress" id="open4">
                                <div class="contact-form form-style">
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6 col-md-12 col-12">
                                            <select name="ship_country"  id="Country2" class="form-control w-100">
                                                <option value="" >Select Country</option>
                                        ...
                                        <div class="col-lg-6 col-md-12 col-12">
                                            <select name="ship_city"  id="City2" class="form-control w-100">
                                                <option value="" >Select Country</option>
                ...
                <div class="cout-order-area">
                    ...
                    <div class="oreder-item">
                        ...
                        <div class="mt-3 mb-3">
                            ...
                            <ul>
                                <li class="free">
                                    <input id="Free" type="radio" name="color" value="70">
                                    <label for="Free">Inside City: <span>&#2547;70</span></label>
                                </li>
                                <li class="free">
                                    <input id="Local" type="radio" name="color" value="120">
                                    <label for="Local">Outside City: <span>&#2547;120</span></label>
                                </li>
                            </ul>
                        </div>
                        <div class="title s2">
                            <h2>Total<span>&#2547;{{$sub}}</span></h2>
                        </div>
                    </div>
                </div>
